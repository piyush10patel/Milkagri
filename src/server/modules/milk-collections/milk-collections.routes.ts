...
import { authorize, authorizeRoleOrPermission } from '../../middleware/authorize.js';
...
router.post('/', authorizeRoleOrPermission('delivery_agent', 'milk_collection'), csrfProtection, validate({ body: saveMilkCollectionSchema }), controller.saveEntry);
